...
namespace DoctorERP
{
    public partial class FrmLandQtyRpt : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmLandQtyRpt(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            if (CmbLandStatus.SelectedIndex == 0)
                ...
                vwLandQty.Fill("Status", (object)CmbLandStatus.Text);
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
           // Reports.GenerateReport(ReportTitle, DataGridMain, dgvManager.mBoundDataView.ToTable());
            ...
            Reports.InitReport(rpt, "landqtyrpt.frx", false);

            rpt.SetParameterValue("UserName", FrmMain.CurrentUser.name);
            rpt.SetParameterValue("Title",this.Text);
