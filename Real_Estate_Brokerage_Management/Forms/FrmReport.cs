...
namespace DoctorERP
{
    public partial class FrmReport : KryptonForm
    {
        ...
        public FrmReport(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            tbTable.Fill();
            DataGridMain.DataSource = tbTable.dtData;
        ...
        void InitGrid()
        {
            tbTable.Fill("Guid", Guid.Empty);
            DataGridMain.DataSource = tbTable.dtData;

            DataGUIAttribute.FillGrid(DataGridMain, typeof(tbTable));
