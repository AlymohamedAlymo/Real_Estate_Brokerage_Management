...
{
    public partial class FrmOfficeRptNetPriceVAT : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmOfficeRptNetPriceVAT(string ReportTitle)
        {
            InitializeComponent();
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "officerptnetpricediscountfeevat.frx", false);
