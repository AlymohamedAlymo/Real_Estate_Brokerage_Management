...
{
    public partial class FrmOwnerLandNetPriceandPayments : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmOwnerLandNetPriceandPayments(string ReportTitle)
        {
            InitializeComponent();
        ...
        private void CalcTotal()
        {
            ...
            decimal amountin = CalcColumnTotal(DataGridMain, DataGridMain.Columns["landpayments"]);
            decimal remain = CalcColumnTotal(DataGridMain, DataGridMain.Columns["landremain"]);
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "OwnerLandNetPriceandPayments.frx", false);
