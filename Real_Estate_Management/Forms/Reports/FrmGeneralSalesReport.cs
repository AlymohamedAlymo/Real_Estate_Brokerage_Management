...
{
    public partial class FrmGeneralSalesReport : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmGeneralSalesReport(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            if (CmbChangeDate.SelectedIndex == 0)
                ...
                vwGeneralSales.Fill(dtStartDate.Value, dtEndDate.Value);

            DataGridMain.DataSource = vwGeneralSales.dtData;
        ...
        void InitGrid()
        {
            vwGeneralSales.Fill("Guid", Guid.Empty);
            DataGridMain.DataSource = vwGeneralSales.dtData;

            DataGUIAttribute.FillGrid(DataGridMain, typeof(vwGeneralSales));
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "workfeerpt.frx", false);
