...
{
    public partial class FrmDailySellGrouped : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmDailySellGrouped(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            if (CmbChangeDate.SelectedIndex == 0)
                vwDailySalesGrouped.Fill("مباع");
            else
                vwDailySalesGrouped.Fill("مباع", dtStartDate.Value, dtEndDate.Value);
        ...
        void InitGrid()
        {
            vwDailySalesGrouped.Fill("مباع", new DateTime(1900, 1, 1), new DateTime(1900, 1, 1));
            DataGridMain.DataSource = vwDailySalesGrouped.dtData;
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "dailysellgrouped.frx", false);
