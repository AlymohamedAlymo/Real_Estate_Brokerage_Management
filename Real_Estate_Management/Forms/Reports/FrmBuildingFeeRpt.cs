...
{
    public partial class FrmBuildingFeeRpt : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmBuildingFeeRpt(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            if (CmbChangeDate.SelectedIndex == 0)
                ...
                vwBuildingFee.Fill(dtStartDate.Value, dtEndDate.Value);

            DataGridMain.DataSource = vwBuildingFee.dtData;
        ...
        void InitGrid()
        {
            vwBuildingFee.Fill("Guid", Guid.Empty);
            DataGridMain.DataSource = vwBuildingFee.dtData;

            DataGUIAttribute.FillGrid(DataGridMain, typeof(vwBuildingFee));
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "buildingfeerpt.frx", false);
