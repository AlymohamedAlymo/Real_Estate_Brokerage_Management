...
{
    public partial class FrmWorkFeeVATRpt : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmWorkFeeVATRpt(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            if (CmbChangeDate.SelectedIndex == 0)
                vwWorkFeeTotals.Fill();
            else if (CmbChangeDate.SelectedIndex != 0)
                vwWorkFeeTotals.Fill(dtStartDate.Value, dtEndDate.Value);

            DataGridMain.DataSource = vwWorkFeeTotals.dtData;
        ...
        void InitGrid()
        {
            vwWorkFeeTotals.Fill("Guid", Guid.Empty);
            DataGridMain.DataSource = vwWorkFeeTotals.dtData;

            DataGUIAttribute.FillGrid(DataGridMain, typeof(vwWorkFeeTotals));
        ...
        private void CalcTotal()
        {
            ...
            decimal vatvalue = CalcColumnTotal(DataGridMain, DataGridMain.Columns["vatvalue"]);
            ...
            LblTotalWorkFeeVAT.Text = string.Format("إجمالي الضريبة {0:" + DataGUIAttribute.CurrencyFormat + "}", vatvalue);
