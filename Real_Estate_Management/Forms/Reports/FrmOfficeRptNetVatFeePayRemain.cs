...
{
    public partial class FrmOfficeRptNetVatFeePayRemain : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmOfficeRptNetVatFeePayRemain(string ReportTitle)
        {
            InitializeComponent();
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "OfficeRptNetVatFeePayRemain.frx", false);
