...
namespace DoctorERP
{
    public partial class FrmOfficeRptPriceFeeDiscount : KryptonForm
    {
        DgvFilterManager dgvManager;
        string ReportTitle = string.Empty;


        public FrmOfficeRptPriceFeeDiscount(string ReportTitle)
        {
            InitializeComponent();
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "officerptnetpricediscountfee.frx", false);
