...
namespace Real_Estate_Management
{
    public partial class FrmDailyReturnSellRpt : KryptonForm
    {
        ...
        public FrmDailyReturnSellRpt(string ReportTitle)
        {
            InitializeComponent();
        ...
        void FillGrid()
        {
            ...
            if (CmbChangeDate.SelectedIndex == 0)
                vwDailSells.Fill("status", "مرتجع");
            else
                vwDailSells.Fill("مرتجع", dtStartDate.Value, dtEndDate.Value);
        ...
        private bool Readyreport(FastReport.Report rpt)
        {
            ...
            Reports.InitReport(rpt, "dailyreturnsellrpt.frx", false);
